...
import { CreateUpdateItemGroupInputDto, ItemGroupServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class CreateItemGroupComponent extends DynamicDialogBase implements OnInit {
    saving = false;
    ...
    initModel() {
        this.model = new CreateUpdateItemGroupInputDto();
    };

    save(form?: NgForm): void {
        this.saving = true;

        this._itemGroupService.create(this.model)
