...
import { CreateUpdateUnitInputDto, UnitDetailDto, UnitServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class EditUnitComponent extends DynamicDialogBase implements OnInit {
    saving = false;
    ...
    getDetail() {
        ...
        this._unitService
            ...
            .subscribe((result: UnitDetailDto) => {
                this.model = new CreateUpdateUnitInputDto(result);
            });
    }
    ...
    save(): void {
        ...
        this._unitService.update(this.model)
            .pipe(finalize(() => this.saving = false))
            .subscribe((result) => {
