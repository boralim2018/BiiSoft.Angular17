...
export class BOMComponent extends Mixin(PrimeNgListComponentBase<BOMListDto>, ExcelFileComponentBase, NavBarComponentBase) implements OnInit {
    ...
    protected getList(input: any, callBack: Function) {
        ...
        this._bomService
            .getList(input.typeFilter.exclude, input.typeFilter.ids, input.itemFilter.exclude, input.itemFilter.ids, input.isActive, input.creators.exclude, input.creators.ids, input.modifiers.exclue, input.modifiers.ids, input.keyword, input.sortField, input.sortMode, input.usePagination, input.skipCount, input.maxResultCount)
