...
export class ZoneComponent extends Mixin(PrimeNgListComponentBase<ZoneListDto>, ExcelFileComponentBase, NavBarComponentBase) implements OnInit {
    ...
    protected getList(input: any, callBack: Function) {
        ...
        this._zoneService
            .getList(input.warehouseFilter.exclude, input.warehouseFilter.ids, input.isActive, input.creatorFilter.exclude, input.creatorFilter.ids, input.modifierFilter.exclude, input.modifierFilter.ids, input.keyword, input.sortField, input.sortMode, input.usePagination, input.skipCount, input.maxResultCount)
