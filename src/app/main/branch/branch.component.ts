...
export class BranchComponent extends Mixin(PrimeNgListComponentBase<BranchListDto>, ExcelFileComponentBase, NavBarComponentBase) implements OnInit {
    ...
    protected initColumns() {
        this.columns = [
            ...
            { name: 'CountryName', header: 'Country', width: '15rem', visible: false },
            { name: 'CityProvinceName', header: 'CityProvince', width: '15rem', visible: false },
            { name: 'KhanDistrictName', header: 'KhanDistrict', width: '15rem', visible: false },
            { name: 'SangkatCommuneName', header: 'SangkatCommune', width: '15rem', visible: false },
            { name: 'VillageName', header: 'Village', width: '15rem', visible: false },
