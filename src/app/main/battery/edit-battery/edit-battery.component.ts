...
import { CreateUpdateBatteryInputDto, BatteryDetailDto, BatteryServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class EditBatteryComponent extends DynamicDialogBase implements OnInit {
    ...
    getDetail() {
        ...
        this._batteryService
            ...
            .subscribe((result: BatteryDetailDto) => {
                this.model = new CreateUpdateBatteryInputDto(result);
            });
    }
    ...
    save(): void {
        ...
        this._batteryService.update(this.model)
            .pipe(finalize(() => this.saving = false))
            .subscribe((result) => {
