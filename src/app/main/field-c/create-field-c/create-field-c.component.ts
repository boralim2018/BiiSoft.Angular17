...
import { CreateUpdateFieldCInputDto, FieldCServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class CreateFieldCComponent extends DynamicDialogBase implements OnInit {
    ...
    initModel() {
        this.model = new CreateUpdateFieldCInputDto();
    };

    save(form?: NgForm): void {
        this.saving = true;

        this._fieldCService.create(this.model)
