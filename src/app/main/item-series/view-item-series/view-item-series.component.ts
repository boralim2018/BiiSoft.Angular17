...
import { ItemSeriesDetailDto, ItemSeriesServiceProxy, GuidEntityDto } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'app-view-item-series',
    templateUrl: './view-item-series.component.html',
...
export class ViewItemSeriesComponent extends Mixin(AppComponentBase, NavBarComponentBase) implements OnInit {
    ...
    delete(): void {
        ...
        this._dialogService.open(ConfirmDeleteComponent, {
            ...
            .onClose.subscribe(result => {
                if (result) {
                    this.loading = true;
                    this._itemSeriesService.delete(this.model.id)
                        .pipe(finalize(() => this.loading = false))
                        .subscribe(() => {
    ...
    showEdit() {
        ...
        let dialog = this._dialogService.open(EditItemSeriesComponent, {
