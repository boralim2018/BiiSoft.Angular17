...
import { CreateUpdateItemSeriesInputDto, ItemSeriesServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'app-create-item-series',
    templateUrl: './create-item-series.component.html',
...
export class CreateItemSeriesComponent extends DynamicDialogBase implements OnInit {
    saving = false;
    ...
    initModel() {
        this.model = new CreateUpdateItemSeriesInputDto();
    };

    save(form?: NgForm): void {
        this.saving = true;

        this._itemSeriesService.create(this.model)
