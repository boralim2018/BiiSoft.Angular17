...
import { CreateUpdateColorPatternInputDto, ColorPatternServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'app-create-color-pattern',
    templateUrl: './create-color-pattern.component.html',
...
export class CreateColorPatternComponent extends DynamicDialogBase implements OnInit {
    ...
    initModel() {
        this.model = new CreateUpdateColorPatternInputDto();
    };

    save(form?: NgForm): void {
        this.saving = true;

        this._colorPatternService.create(this.model)
