...
import { CreateUpdateFieldAInputDto, FieldAServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'app-create-field-a',
    templateUrl: './create-field-a.component.html',
...
export class CreateFieldAComponent extends DynamicDialogBase implements OnInit {
    saving = false;
    ...
    initModel() {
        this.model = new CreateUpdateFieldAInputDto();
    };

    save(form?: NgForm): void {
        this.saving = true;

        this._fieldAService.create(this.model)
