...
import { CreateUpdateItemGradeInputDto, ItemGradeServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'app-create-item-grade',
    templateUrl: './create-item-grade.component.html',
...
export class CreateItemGradeComponent extends DynamicDialogBase implements OnInit {
    saving = false;
    ...
    initModel() {
        this.model = new CreateUpdateItemGradeInputDto();
    };

    save(form?: NgForm): void {
        this.saving = true;

        this._itemGradeService.create(this.model)
