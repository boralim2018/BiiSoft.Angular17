...
import { CreateUpdateItemBrandInputDto, ItemBrandServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    selector: 'app-create-item-brand',
    templateUrl: './create-item-brand.component.html',
...
export class CreateItemBrandComponent extends DynamicDialogBase implements OnInit {
    saving = false;
    ...
    initModel() {
        this.model = new CreateUpdateItemBrandInputDto();
    };

    save(form?: NgForm): void {
        this.saving = true;

        this._itemBrandService.create(this.model)
