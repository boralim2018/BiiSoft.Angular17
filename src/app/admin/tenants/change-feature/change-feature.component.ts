...
@Component({
    selector: 'app-edit',
    templateUrl: './change-feature.component.html',
    styleUrls: ['./change-feature.component.scss'],
    providers: [TenantServiceProxy],
    standalone: true,
    imports: [FormsModule, BusyDirective, TreeModule, PrimeTemplate, NgIf, InputNumberModule, InputTextModule, DropdownModule, ButtonDirective, Ripple, LocalizePipe]
})
export class ChangeFeatureComponent extends DynamicDialogBase implements OnInit {
    ...
    save(): void {
        ...
        input.featureValues = this.allNodes.map(n => {
