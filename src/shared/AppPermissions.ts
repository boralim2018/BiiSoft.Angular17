    ...
    static pages = {
        ...
        setup: {
            ...
            items: {
                ...
                priceLevels: {
                    page: "Pages.Setup.Items.PriceLevels",
                    create: "Pages.Setup.Items.PriceLevels.Create",
                    view: "Pages.Setup.Items.PriceLevels.View",
                    edit: "Pages.Setup.Items.PriceLevels.Edit",
                    delete: "Pages.Setup.Items.PriceLevels.Delete",
                    importExcel: "Pages.Setup.Items.PriceLevels.ImportExcel",
                    exportExcel: "Pages.Setup.Items.PriceLevels.ExportExcel",
                    enable: "Pages.Setup.Items.PriceLevels.Enable",
                    disable: "Pages.Setup.Items.PriceLevels.Disable",
                },
            ...
            warehouses: {
                ...
                slots: {
                    page: "Pages.Setup.Warehouses.Slots",
                    create: "Pages.Setup.Warehouses.Slots.Create",
                    view: "Pages.Setup.Warehouses.Slots.View",
                    edit: "Pages.Setup.Warehouses.Slots.Edit",
                    delete: "Pages.Setup.Warehouses.Slots.Delete",
                    importExcel: "Pages.Setup.Warehouses.Slots.ImportExcel",
                    exportExcel: "Pages.Setup.Warehouses.Slots.ExportExcel",
                    enable: "Pages.Setup.Warehouses.Slots.Enable",
                    disable: "Pages.Setup.Warehouses.Slots.Disable",
                },
            },
