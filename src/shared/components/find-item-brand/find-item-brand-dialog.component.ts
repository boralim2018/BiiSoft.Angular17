...
@Component({
    ...
    templateUrl: './find-item-brand-dialog.component.html',
...
export class FindItemBrandDialogComponent extends Mixin(FindCardListComponentBase<FindItemBrandDto>, AppDynamicDialogBase) implements OnInit {

    protected get sortField(): string { return 'Name'; }

    @ViewChild('findItemBrandTable') table: Table;
