...
@Component({
    ...
    templateUrl: './find-ram-dialog.component.html',
...
export class FindRAMDialogComponent extends Mixin(FindCardListComponentBase<FindRAMDto>, AppDynamicDialogBase) implements OnInit {

    protected get sortField(): string { return 'Name'; }

    @ViewChild('findRAMTable') table: Table;
