...
export class FindItemModelDialogComponent extends Mixin(FindCardListComponentBase<FindItemModelDto>, AppDynamicDialogBase) implements OnInit {

    protected get sortField(): string { return 'Name'; }

    @ViewChild('findItemModelTable') table: Table;
