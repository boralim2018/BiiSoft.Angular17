...
@Component({
    selector: 'select-bom-type, [selectBOMType]',
    templateUrl: '../template/select-template.component.html',
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => SelectBOMTypeComponent),
            multi: true,
        },
        {
...
export class SelectBOMTypeComponent extends SelectComponentBase implements OnInit {
